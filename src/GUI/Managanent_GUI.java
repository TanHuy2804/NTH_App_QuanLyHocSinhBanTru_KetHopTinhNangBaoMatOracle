...
public class Managanent_GUI extends javax.swing.JFrame {
    ...
    private CheckSessionWorker sessionWorker;
    /**
    ...
    public Managanent_GUI() {
        ...
        //sessionWorker = new CheckSessionWorker(this);
    ...
    private void initComponents() {
        ...
        btn_NhanVien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/manager.png"))); // NOI18N
        btn_NhanVien.setText("Quản trị người dùng");
        ...
        btn_DiemDanh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/attendance.png"))); // NOI18N
        ...
        btn_TaoDeThi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/sketchbook.png"))); // NOI18N
        ...
        btn_thiOnline.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/online-test.png"))); // NOI18N
        btn_thiOnline.setText("Làm kiểm tra");
    ...
    public class CheckSessionWorker extends SwingWorker<Boolean, Void> {
        private final Managanent_GUI Managanent_GUI; // Tham chiếu đến JFrame Managanent_GUI

        public CheckSessionWorker(Managanent_GUI Managanent_GUI) {
            this.Managanent_GUI = Managanent_GUI;
        }

        @Override
        protected Boolean doInBackground() throws Exception {
            boolean sessionExists = true;
            DAO_KiemTraSession dao = new DAO_KiemTraSession(); // Khởi tạo DAO để kiểm tra phiên làm việc

            while (sessionExists && !isCancelled()) { // Kiểm tra liệu có bị hủy không
                sessionExists = DAO_KiemTraSession.KiemTraSession(Managanent_GUI.username);
    ...
    private void btn_dangXuatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_dangXuatActionPerformed
        // TODO add your handling code here:
        TrangChu_GUI qldn = new TrangChu_GUI();
    ...
    private void btn_thiOnlineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_thiOnlineActionPerformed
        ...
        String kitu_User = Login_GUI.kitu_User;
        System.out.println("Chuc vu: " + kitu_User);
        if ( "Quan Tri He Thong".equals(tenchucvu) || "HS".equals(kitu_User) || "Giao Vien".equals(tenchucvu)) {
