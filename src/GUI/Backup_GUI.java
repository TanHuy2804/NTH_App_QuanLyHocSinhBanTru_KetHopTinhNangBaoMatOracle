...
public class Backup_GUI extends javax.swing.JFrame {
    ...
    public Backup_GUI() {
        ...
        modelTrangThaiCongNo.addElement("BACKUP DATABASE PLUS ARCHIVELOG");
        modelTrangThaiCongNo.addElement("BACKUP CURRENT CONTROLFILE");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sao lưu và Phục hồi ");

        btn_backup.setText("Sao lưu dữ liệu với Dump");
        ...
        btn_retore.setText("Phục hồi dữ liệu với Dump");
        ...
        btn_backup_rman.setText("Sao lưu dữ liệu với Rman");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Kiểu sao lưu dữ liệu"));
    ...
    private void btn_backup_rmanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_backup_rmanActionPerformed
        // TODO add your handling code here:
         try {
            ...
            // Gửi lệnh CONNECT
            //sendCommand(printWriter, "CONNECT TARGET SYS/Nth99999@DBHSBT");
            sendCommand(printWriter, "CONNECT TARGET \"SYS/Nth99999@'(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=13.82.232.25)(PORT=1521))(CONNECT_DATA=(SID=DBHSBT)))' AS SYSDBA\"");
